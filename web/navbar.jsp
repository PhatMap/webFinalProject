                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="controlHome" class="nav-item nav-link">Home</a>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <c:if test="${sessionScope.acc.issell==true}">
                                ...
                                <a href="controlPrint" ><button style="background-color:yellow;">Manage bill</button></a>
                            </c:if>
                            <c:if test="${sessionScope.acc.isadmin==true}">
                                <a href="controlAdmin" ><button style="background-color:yellow;">Manage account</button></a>
                            </c:if>
                        </div>
                    </div>
                </nav>
