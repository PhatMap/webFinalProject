...
public class DAO {
       ...
       public static void saveProfile(String currAccountid,String name,String email,String address,String username,String password,String sdt){
