 ...
 */
@WebServlet(name = "controlSetBill", urlPatterns = {"/controlSetBill"})
public class controlSetBill extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(currAccount!=null){
            ...
            Account user = DAO.getUserAccount(currAccount.getAcid().toString());
